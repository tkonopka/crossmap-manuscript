...
#' Create a separate plot with just a labels for a y-axis
#'
#' @param t character, text to print
#' @param srt numeric, a rotate factor
#' @param Rcssclass character, style
#'
plotSeparateText <- function(t, srt=0, Rcssclass=c()) {
  RcssCompulsoryClass <- c("separate", Rcssclass)
  par()
